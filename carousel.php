...
<div class="carousel-inner" role="listbox">
  <div class="item">
    <img class="first-slide img-responsive" src="images/avengers.jpg" alt="First slide">
    <div class="container">
      
    </div>
  </div>
  <div class="item">
    <img class="first-slide img-responsive" src="images/tenet.jpg" alt="First slide">
    <div class="container">
      
    </div>
  </div>
  <div class="item active">
    <img class="second-slide img-responsive" src="images/blackwidow.jpg" alt="Second slide">
    <div class="container">
